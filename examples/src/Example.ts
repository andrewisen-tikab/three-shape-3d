...
import type { Mode } from "../../src/controls/TransformShapeControls/types";
...
export default class Example {
	...
	public async initAsync(): Promise<void> {
		...
		this.transformShapeControls.addEventListener(
			"dragging-changed",
			(event) => {
		...
		const backgroundPlane =
			await this.gltflLoader.loadAsync("../../../base.glb");
		...
		const backgroundBuildings = await this.gltflLoader.loadAsync(
			"../../../buildings.glb",
		);
